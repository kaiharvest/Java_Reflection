...
import indradwiprabowo.reflection.data.Product;
...
public class RecordTest {
    ...
    @Test
    void testClassGetRecordValue() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        Class<Product> productClass = Product.class;
        Method id = productClass.getDeclaredMethod("id");

        Product product = new Product("1", "Apple", 2000000L);
    ...
    void testGetRecordValueByComponent() throws InvocationTargetException, IllegalAccessException {
        ...
        Product product = new Product("1", "Iphone", 15000000L);
